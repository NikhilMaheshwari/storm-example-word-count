...
import com.example.bolt.RollingCountBolt;
 ...
 */
public class TweetRollingTopology {
    public static void main(String[] args) {
        ...
        topologyBuilder.setBolt("rolling-count-bolt", new RollingCountBolt(), 1).fieldsGrouping("parse-tweet-bolt", new Fields("tweet-word"));
